...
extern void BackupEntityLists(void);
extern bool32 sub_080A51F4(void);
extern u32 CheckGameCondition(u32, u32);
...
u32 sub_080A6F40(void) {
    ...
    for (uVar3 = 0, pcVar2 = gUnk_08128F38, uVar4 = 0; *pcVar2 != 0; uVar3++, pcVar2 += 2) {
        uVar4 |= CheckGameCondition(*pcVar2, pcVar2[1]) << uVar3;
    }
    return ~uVar4;
}
...
void MenuFadeIn(u32 param_1, u32 param_2) {
    ...
    gTransitionState.stageIndex = 0;
    gTransitionState.progressFlag = 0;
}
...
void Subtask_FadeOut(void) {
    if (!gFadeControl.active) {
        ...
        HandleRoomTransitionObjPalettes(gUI.unk_d != 0);
        sub_080A74F4();
