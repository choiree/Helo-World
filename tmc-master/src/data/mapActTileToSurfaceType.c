...
const KeyValuePair gMapActTileToSurfaceType[] = {
    ...
    { ACT_TILE_8, SURFACE_CRACKING_GROUND },
    ...
    { ACT_TILE_101, SURFACE_MINECART_TRACK },
    { ACT_TILE_102, SURFACE_MINECART_TRACK },
    { ACT_TILE_103, SURFACE_MINECART_TRACK },
    { ACT_TILE_104, SURFACE_MINECART_TRACK },
    { ACT_TILE_105, SURFACE_MINECART_TRACK },
    { ACT_TILE_106, SURFACE_MINECART_TRACK },
    { ACT_TILE_108, SURFACE_MINECART_TRACK },
    { ACT_TILE_109, SURFACE_MINECART_TRACK },
    { ACT_TILE_110, SURFACE_MINECART_TRACK },
    { ACT_TILE_111, SURFACE_MINECART_TRACK },
    { ACT_TILE_107, SURFACE_MINECART_TRACK },
