...
enum PlayerActions {
    ...
    PLAYER_PUSH,
    PLAYER_BOUNCE,
    PLAYER_KINSTONE_PROMPT, // sub_080782C0, only when pressing L to start a Kinstone Fusion
    PLAYER_ITEMGET,
    PLAYER_MINISH,
    PLAYER_MINISHDIE,
...
enum PlayerFrameState {
    ...
    PL_STATE_HIDDEN,
    PL_STATE_USEPORTAL,
    PL_STATE_MOLDWORM_CAPTURED,
    PL_STATE_TRAPPED,
    PL_STATE_SPECIAL_ACTION,
    PL_STATE_DIE,
    PL_STATE_TALKEZLO,
    PL_STATE_CAPE,
    PL_STATE_ITEMGET,
...
typedef enum {
    ...
    PL_BOSS_BATTLE = 0x40000000,
    PL_CUTSCENE_MODE = 0x80000000,
} PlayerFlags;
...
typedef enum {
    ...
    SURFACE_MINECART_TRACK,
    SURFACE_CRACKING_GROUND,
...
typedef struct {
    ...
    /*0x02*/ u8 swordType;
    /*0x03*/ u8 unk_3;// chargeLevel
    /*0x04*/ s16 chargeTimer;
    /*0x06*/ u8 unk_6[2]; // padding[2]
} ChargeState;
...
bool32 CanPlayerInteractWithEntity(Entity*, u32);
