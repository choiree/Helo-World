...
typedef struct {
    /*0x00*/ GfxSlotStatus status : 4;
    /*0x00*/ GfxSlotVramStatus vramStatus : 4; // Whether the gfx was uploaded to the vram?
    /*0x01*/ u8 slotCount;
...
typedef struct {
    ...
    u8 mushroomStalkTrigger1;
    u8 mushroomStalkTrigger2;
    u8 mushroomStalkTrigger3;
    u8 completionFlag;
} TransitionState;

extern TransitionState gUnk_02018EB0;
