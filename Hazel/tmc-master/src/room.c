...
extern void LoadRoomTileEntities(void);
...
extern void ProcessKinstoneWorldEvents(void);
extern void UpdateOpenedSmallChests(void);
...
void InitializeEntityFromData(Entity*, const EntityData*);
void SetRoomProperties(void** properties);

void GetAreaLocalFlagBank(void);
...
// r4/r5 regalloc
    ...
    if (entity != NULL) {
        ...
        if ((dat->flags & 0xF0) != 16) {
            ...
            if (kind == 9)
                return entity;
            InitializeEntityFromData(entity, dat);
            if (!entity->next)
                return entity;
            kind2 = dat->kind & 0xF0;
            if ((kind2 & 0x10) == 0) {
...
void InitializeEntityFromData(Entity* ent, const EntityData* dat) {
...
void InitRoomProperties(void) {
    SetRoomProperties(gArea.pCurrentRoomInfo->properties);
    ClearSmallChests();
}
...
void UpdateOpenedSmallChests(void) {
