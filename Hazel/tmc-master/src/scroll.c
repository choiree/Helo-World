...
extern void ExpandMapDataToGrid(u16*, u32, u32);
extern void InitializeDiggingCaveEntrance();
extern void DeleteSleepingEntities(void);
extern void InitializeRoomCollisionData();
extern void CreateCollisionDataBorderAroundRoom();
extern void DarkNut_CheckPlayerRange();
...
void Scroll5Sub1(RoomControls* controls) {
    ...
    ExpandMapDataToGrid(gMapTop.mapData, controls->width >> 4, controls->height >> 4);
...
void UpdateRoomScrollFromCamera(void) {
    s32 x, y;
    s32 var1, var0;
    RoomControls* roomControls = &gRoomControls;
...
void sub_08080C80(MapDataDefinition* dataDefinition) {
    ...
    ExpandMapDataToGrid(gMapBottom.mapData, gRoomControls.width / 16, gRoomControls.height / 16);
    ExpandMapDataToGrid(gMapTop.mapData, gRoomControls.width / 16, gRoomControls.height / 16);
}
