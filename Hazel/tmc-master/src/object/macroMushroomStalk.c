...
void MacroMushroomStalk_Action1(Entity* this) {
    ...
    switch (this->type) {
        case 1:
            if (gTransitionState.mushroomStalkTrigger1 != 0) {
                this->timer = 32;
                gTransitionState.mushroomStalkTrigger1 = 0;
                SoundReq(SFX_12E);
            }
            break;
        case 2:
            if (gTransitionState.mushroomStalkTrigger2 != 0) {
                this->timer = 32;
                gTransitionState.mushroomStalkTrigger2 = 0;
                SoundReq(SFX_12E);
            }
            break;
        case 3:
            if (gTransitionState.mushroomStalkTrigger3 != 0) {
                this->timer = 32;
                gTransitionState.mushroomStalkTrigger3 = 0;
                SoundReq(SFX_12E);
            }
            break;
    }
