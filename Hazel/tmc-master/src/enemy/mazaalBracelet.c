...
void sub_0803B798(void) {
    ...
    movementFlags = 0;
    gPlayerState.flags &=
        ~(PL_CAPTURED | PL_SPECIAL_MOVEMENT | PL_GYORG_FIGHT | PL_ROLLING | PL_MOLDWORM_CAPTURED | PL_IN_HOLE |
          PL_MOLDWORM_RELEASED | PL_CLONING | PL_USE_LANTERN | PL_PARACHUTE | PL_CONVEYOR_PUSHED | PL_ENTER_MINECART |
          PL_SWORD_THRUST | PL_USE_OCARINA | PL_CLIMBING | PL_BOSS_BATTLE | PL_CUTSCENE_MODE);
