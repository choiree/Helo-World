...
#define HZ_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Hazel.InternalCalls::" #Name, Name)
	...
	{
		HZ_CORE_WARN("Value: [{0}, {1}, {2}]", parameter->x, parameter->y, parameter->z);
	...
	static void Rigidbody2DComponent_ApplyLinearImpulseToCenter(UUID entityID, glm::vec2* impulse, bool wake)
	{
		...
		auto& rb2d = entity.GetComponent<Rigidbody2DComponent>();
		b2BodyId b2d = rb2d.RuntimeBody;
		b2Body_ApplyLinearImpulseToCenter(b2d, {impulse->x, impulse->y}, wake);
	}
	...
	static void Rigidbody2DComponent_GetLinearVelocity(UUID entityID, glm::vec2* outLinearVelocity)
	{
		...
		auto& rb2d = entity.GetComponent<Rigidbody2DComponent>();
		b2BodyId b2d = rb2d.RuntimeBody;
		const b2Vec2& linearVelocity = b2Body_GetLinearVelocity(b2d);
	...
	static Rigidbody2DComponent::BodyType Rigidbody2DComponent_GetType(UUID entityID)
	{
		...
		auto& rb2d = entity.GetComponent<Rigidbody2DComponent>();
		b2BodyId b2d = rb2d.RuntimeBody;
		return Utils::Rigidbody2DTypeFromBox2DBody(b2Body_GetType(b2d));
	}
	...
	static void Rigidbody2DComponent_SetType(UUID entityID, Rigidbody2DComponent::BodyType bodyType)
	{
		...
		auto& rb2d = entity.GetComponent<Rigidbody2DComponent>();
		b2BodyId b2d = rb2d.RuntimeBody;
		b2Body_SetType(b2d, Utils::Rigidbody2DTypeToBox2DBody(bodyType));
	}
